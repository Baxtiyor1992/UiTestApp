...
public class CustomSubtitleText extends AppCompatTextView {

    private final StringBuilder stringBuilder = new StringBuilder();

    public CustomSubtitleText(Context context) {
        super(context);
    }

    public CustomSubtitleText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomSubtitleText(Context context, AttributeSet attrs, int defStyleAttr) {
